...
public:
	...
	void setKeyCallback(const std::function<void(Key, KeyState)>& callback) { m_keyboardCallback = callback; };
...
private:
	...
	std::function<void(const Key, const KeyState)> m_keyboardCallback;
};
