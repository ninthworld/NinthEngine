...
private:
	...
	std::shared_ptr<Texture> m_textureDisp;
	std::shared_ptr<Texture> m_textureNrm;
	std::shared_ptr<Texture> m_textureOcc;
	std::shared_ptr<Texture> m_textureSpec;
	std::shared_ptr<IndexBuffer> m_indexBuffer;
	std::shared_ptr<VertexArray> m_vertexArray;
	std::shared_ptr<ConstantsBuffer> m_constantsCam;
	std::shared_ptr<ConstantsBuffer> m_constantsLight;
