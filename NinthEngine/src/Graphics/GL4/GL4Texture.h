...
public:
	...
	inline std::shared_ptr<Sampler> getSampler() override { return m_sampler; };
	inline void setSampler(const std::shared_ptr<Sampler>& sampler) override { m_sampler = sampler; };
